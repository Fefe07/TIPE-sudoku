...
#plt.scatter(identite, repartition, s=20, label="Répartition")
#plt.scatter(identite, repartition_valeurs, s=20, label="Répartition valeurs")
#plt.scatter(identite, mix, s=20, label ="Mix")
plt.xlabel("Sudokus")
plt.ylabel("Difficulté(entier arbitraire) / nombre de notes/25")
