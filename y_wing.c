      ...
      if (compteur(notes[i][j]) == 2) { 
        ...
        for (int i1 = 0; i1 < 9; i1++) {
          for (int j1 = 0; j1 < 9; j1++) {
            if ((i1 != i || j1 != j) && (compteur(notes[i1][j1]) == 2) &&
                same_zone(i, j, i1, j1) ) {
              ...
              if (pincer_1[0] != -1 && pincer_1[1] != -1) {
                ...
                for (int i2 = 0; i2 < 9; i2++) {
                  for (int j2 = 0; j2 < 9; j2++) {
                    if ((i2 != i || j2 != j) && (compteur(notes[i2][j2]) == 2) &&
                        same_zone(i, j, i2, j2) && 
                      ...
                      if (pincer_2[0] != -1 && pincer_2[1] != -1) {
                        ...
                        if (valide[1] && valide[2]) {
                          ...
                          //printf("%d %d %d %d %d %d %d %d\n", pincer_1[0] , pincer_2[0], pincer_1[1] , pincer_2[1], position_pince[0], position_pince[1],
